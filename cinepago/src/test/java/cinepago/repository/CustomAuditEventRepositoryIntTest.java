...
import cinepago.config.audit.AuditEventConverter;
import cinepago.domain.PersistentAuditEvent;
...
import static cinepago.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
