...
import cinepago.domain.Cliente;
...
public class ClienteResourceIntTest {
    ...
    private static final Integer DEFAULT_DOCUMENTO = 0;
    private static final Integer UPDATED_DOCUMENTO = 1;
    ...
    public void createCliente() throws Exception {
        ...
        assertThat(testCliente.getCreated()).isEqualTo(DEFAULT_CREATED);
        assertThat(testCliente.getUpdated()).isEqualTo(DEFAULT_UPDATED);
    }
    ...
    public void updateCliente() throws Exception {
        ...
        assertThat(testCliente.getCreated()).isEqualTo(UPDATED_CREATED);
        assertThat(testCliente.getUpdated()).isEqualTo(UPDATED_UPDATED);
    }
